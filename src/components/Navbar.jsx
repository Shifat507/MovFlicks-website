        ...
        <div>
            <div className="navbar bg-base-100">
                ...
                <div className="navbar-end">
                    ...
                    <label className="swap swap-rotate mr-3 md:mr-5">
                        {/* this hidden checkbox controls the state */}
                        <input onChange={handleToggle} type="checkbox" />

                        {/* sun icon */}
                        <svg
                            className="swap-on h-10 w-5 md:w-8 fill-current"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
                        ...
                        {/* moon icon */}
                        <svg
                            className="swap-off h-10 w-5 md:w-8 fill-current"
                            xmlns="http://www.w3.org/2000/svg"
                            viewBox="0 0 24 24">
                            <path
                    ...
                    </label>
                    {
                        user ? (
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Link to="/" onClick={handleGoogleSignIn} className="text-xl">
                                    <FcGoogle />
                                </Link>
                            </div>
                        )
